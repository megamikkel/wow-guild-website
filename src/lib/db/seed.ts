...
export async function seedDemoData(db: Db) {
  ...
  const reports = await db
    ...
    .values(
      [2, 5, 9, 12].map((d, i) => ({
        ...
        title: `${TIER} — Mythic (${i < 2 ? "Void Emperor progress" : "Farm + Nerezza"})`,
        startTime: daysAgo(d),
  ...
  await db.insert(t.recruitmentNeeds).values([
    { className: "Mage", specName: null, role: "DPS", priority: "HIGH", note: "Any spec, immediate raid spot" },
    { className: "Shaman", specName: "Restoration", role: "HEALER", priority: "HIGH", note: "Core spot for the right player" },
    ...
    { className: "Warrior", specName: "Protection", role: "TANK", priority: "CLOSED", note: "Tank roster full" },
  ]);
    ...
    .values([
      {
        ...
        raidExperience: "7/8M last tier, CE the two tiers before that.",
        availability: "Wed + Sun, can do extra nights on progress weeks.",
        expectations: "Stable roster, prep culture, no drama.",
        whyPapi: "You kill bosses without raiding four nights. That's exactly the balance I want.",
        status: "NEW",
      ...
      },
      {
        ...
        raidExperience: "6/8M current tier. Guild disbanded on Void Emperor.",
        availability: "Both raid days, always.",
        expectations: "A guild that doesn't fall apart in week 8.",
        whyPapi: "Your progression pace matches mine and your roster looks stable.",
        status: "NEW",
      ...
      },
      {
        ...
        raidExperience: "5/8M, strong logs on farm bosses.",
        availability: "Wed always, Sun most weeks.",
        expectations: "Fair rotation policy.",
        whyPapi: "Friends in the guild vouch for the atmosphere.",
        status: "REVIEW",
      ...
      },
      {
        ...
        raidExperience: "8/8M two tiers ago, took a break, coming back.",
        availability: "Both days.",
        expectations: "Serious prog with a sense of humour.",
        whyPapi: "The recruitment post didn't read like a template. That's rare.",
        status: "INTERVIEW",
        reviewerId: officerUser.id,
        createdAt: daysAgo(6),
        updatedAt: daysAgo(2),
  ...
  await db.insert(t.applicationNotes).values([
    {
      ...
      authorName: "Luna",
      body: "Logs check out on farm, thin on prog bosses. Worth an interview.",
      createdAt: daysAgo(1),
    },
    {
      ...
      authorId: officerUser.id,
      authorName: "Luna",
      body: "Interview set for Thursday 20:00. Old guild officer vouches.",
      createdAt: daysAgo(2),
    },
  ]);
  ...
  await db.insert(t.trials).values([
    {
      ...
      raidsAttended: 6,
      attendancePct: 100,
      performanceNote: "Improving every week. Void Emperor uptime already above roster median.",
      status: "ACTIVE",
    },
    {
      ...
      raidsAttended: 7,
      attendancePct: 83,
      performanceNote: "Solid, review due — decide before reset.",
      status: "ACTIVE",
    },
    {
      ...
      raidsAttended: 3,
      attendancePct: 100,
      performanceNote: "Early days, mechanically clean.",
      status: "ACTIVE",
    },
  ]);
  ...
  await db.insert(t.activityEvents).values([
    {
      kind: "boss_kill",
      title: "PAPI defeated Nerezza, Void Weaver (Mythic)",
      detail: "Mythic boss #6 down after 38 pulls.",
      source: "warcraft_logs",
      occurredAt: hoursAgo(2),
    },
    {
      kind: "roster",
      title: "Frostmage joined the roster",
      detail: "Trial — Frost Mage",
      source: "papi",
      occurredAt: hoursAgo(5),
    },
    {
      kind: "mythic_plus",
      title: "PAPI timed a +17",
      detail: "Emberfall, Mikkel and Skyreaver — Ara-Kara +17 in time.",
      source: "raider_io",
      occurredAt: daysAgo(1),
    },
    {
      kind: "progress",
      title: "New best pull on The Void Emperor: 11.7%",
      detail: "38% → 11.7% in one night. 83 pulls total.",
      source: "warcraft_logs",
      occurredAt: daysAgo(2),
    },
    {
      kind: "report",
      title: "New raid report uploaded",
      detail: "Eternal Citadel — Mythic, 2 hours of Void Emperor progress.",
      source: "warcraft_logs",
      occurredAt: daysAgo(2.1),
    },
    {
      kind: "recruitment",
      title: "New application: Arcane Mage",
      detail: "Arcblast — 7/8M experience.",
      source: "papi",
